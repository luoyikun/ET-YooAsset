...
namespace ET
{
    ...
    public class FUI_SkillSmallProBarDestroySystem : DestroySystem<FUI_SkillSmallProBar>
    {
        public override void Destroy(FUI_SkillSmallProBar self)
        {
            self.Destroy();
        }
    }
    ...
    {	
        ...
        public static UniTask<FUI_SkillSmallProBar> CreateInstanceAsync(Entity parent)
        {
            UniTaskCompletionSource<FUI_SkillSmallProBar> tcs = new UniTaskCompletionSource<FUI_SkillSmallProBar>();
    
            CreateGObjectAsync((go) =>
            {
                tcs.TrySetResult(parent.AddChild<FUI_SkillSmallProBar, GObject>(go));
            });
