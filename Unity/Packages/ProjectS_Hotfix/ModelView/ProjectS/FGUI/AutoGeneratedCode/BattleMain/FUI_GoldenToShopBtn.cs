...
namespace ET
{
    ...
    {	
        ...
        public static UniTask<FUI_GoldenToShopBtn> CreateInstanceAsync(Entity parent)
        {
            UniTaskCompletionSource<FUI_GoldenToShopBtn> tcs = new UniTaskCompletionSource<FUI_GoldenToShopBtn>();
    
            CreateGObjectAsync((go) =>
            {
                tcs.TrySetResult(parent.AddChild<FUI_GoldenToShopBtn, GObject>(go));
            });
