...
namespace ET
{
    ...
    public class FUI_Battle_MainDestroySystem : DestroySystem<FUI_Battle_Main>
    {
        public override void Destroy(FUI_Battle_Main self)
        {
            self.Destroy();
        }
    }
    ...
    {	
        ...
        public static UniTask<FUI_Battle_Main> CreateInstanceAsync(Entity parent)
        {
            UniTaskCompletionSource<FUI_Battle_Main> tcs = new UniTaskCompletionSource<FUI_Battle_Main>();
    
            CreateGObjectAsync((go) =>
            {
                tcs.TrySetResult(parent.AddChild<FUI_Battle_Main, GObject>(go));
            });
