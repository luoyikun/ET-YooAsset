...
namespace ET
{
    ...
    {	
        ...
        public static UniTask<FUI_SkillProBar> CreateInstanceAsync(Entity parent)
        {
            UniTaskCompletionSource<FUI_SkillProBar> tcs = new UniTaskCompletionSource<FUI_SkillProBar>();
    
            CreateGObjectAsync((go) =>
            {
                tcs.TrySetResult(parent.AddChild<FUI_SkillProBar, GObject>(go));
            });
