...
namespace ET
{
    ...
    {	
        ...
        public static UniTask<FUI_ProgressBar1> CreateInstanceAsync(Entity parent)
        {
            UniTaskCompletionSource<FUI_ProgressBar1> tcs = new UniTaskCompletionSource<FUI_ProgressBar1>();
    
            CreateGObjectAsync((go) =>
            {
                tcs.TrySetResult(parent.AddChild<FUI_ProgressBar1, GObject>(go));
            });
