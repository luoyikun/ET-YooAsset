...
namespace ET
{
    ...
    public class LSF_TimerAction : Entity, IAwake<TimerClass, uint, object>, IDestroy
    {
    ...
    public class LSF_TimerComponent : Entity, IAwake, IFixedUpdate, IDestroy
    {
        ...
        private long NewRepeatedTimerInner(long time, Action action)
        {
            ...
            LSF_TimerAction timer =
                this.AddChild<LSF_TimerAction, TimerClass, uint, object>(TimerClass.RepeatedTimer, frameCount, action,
                    true);
            this.AddTimer(tillFrame, timer);
            return timer.Id;
        }
