...
namespace ET
{
    ...
    public class BuffDataBase
    {
        ...
        [UnityEngine.Tooltip("是否可以叠加(不能叠加就刷新，叠加满也刷新)")]
        [LabelText("是否叠加")]
        [BoxGroup("选填项")]
        ...
        [LabelText("Buff持续时间")]
        [UnityEngine.Tooltip("-1代表永久,0代表此处设置无效,1000 = 1s")]
        [BoxGroup("选填项")]
        ...
        [BoxGroup("选填项")]
        [UnityEngine.Tooltip("基础数值，比如技能面板伤害100/200/300这种")]
        [BsonDictionaryOptions(DictionaryRepresentation.ArrayOfArrays)]
        public Dictionary<int, float> ValueToBeChanged = new Dictionary<int, float>();

        [UnityEngine.Tooltip("具体的加成(可能会一个效果多种加成方式)，例如法强加成")]
        [BoxGroup("选填项")]
        [BsonDictionaryOptions(DictionaryRepresentation.ArrayOfArrays)]
