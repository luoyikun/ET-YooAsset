...
public sealed partial class LuBanSampleConfig :  Bright.Config.BeanBase 
{
    ...
    public LuBanSample.LuBanSampleConfig UpgradeToItemId_Ref { get; private set; }
    /// <summary>
    /// 过期时间
    /// </summary>
    ...
    public const int __ID__ = -1626556716;
    public override int GetTypeId() => __ID__;

    public  void Resolve(Dictionary<string, object> _tables)
    {
        this.UpgradeToItemId_Ref = (_tables["LuBanSample.TbLuBanSample"] as LuBanSample.TbLuBanSample).GetOrDefault(UpgradeToItemId);
